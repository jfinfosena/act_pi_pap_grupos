# Supermercado con Carrito de Compras

Este proyecto es una aplicación web simple de supermercado con carrito de compras, usando FastAPI (backend) y HTML/JS (frontend).
